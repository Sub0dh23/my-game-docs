Welcome to Cricket League Manager ("we", "our", or "us"). We are committed to protecting your personal information and your right to privacy.
...
• Application refers to Cricket League Manager 26, the software program provided by the Company.
• Company (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Cricket League Manager 26.
...
• Google Analytics: Collects Data to understand how users interact with the game.
• Google AdMob: Show Advertisements. AdMob may collect device-specific information and use cookies for personalized advertising.
...
• Usage Data: Application usage statistics up to 24 months to understand feature adoption and service improvements. Server logs (IP addresses, access times) up to 24 months for security monitoring and troubleshooting purposes.
...
• By email: subzerogamestudio@gmail.com
